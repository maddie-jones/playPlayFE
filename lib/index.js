...
function toggleFavDropD() {
  ...
  if (playlistFavDropD.classList.contains('show')) {
    ...
    playlistFavDropD.attributes['aria-expanded'] = 'false';
  } else {
    ...
    playlistFavDropD.attributes['aria-expanded'] = 'true';
  }
}
...
function ylistFavSection(playlistName) {
